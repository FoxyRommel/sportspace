...
@section('content')
                        ...
                        <form method="POST" action="{{ route('cart.add', $product) }}" class="space-y-8 mt-8">
                            ...
                            <div class="flex flex-wrap items-center gap-3 xs:gap-4">
                                <div class="flex items-stretch h-[54px] lg:h-[72px] gap-2">
                                    <button type="button"
                                            class="w-12 h-full rounded-lg border border-black/30 hover:bg-card/20 active:bg-card/50 focus:border-pink focus:shadow-[0_0_0_3px_#EC4176] bg-white/5 text-black text-xs text-center font-bold shadow-transparent outline-0 transition">
                                        -
                                    </button>
                                    <input name="quantity" type="number"
                                           class="h-full px-2 md:px-4 rounded-lg border border-black/30 focus:border-pink focus:shadow-[0_0_0_3px_#EC4176] bg-white/5 text-black text-xs text-center font-bold shadow-transparent outline-0 transition"
            ...
            <section class="mt-12 xl:mt-16 pt-8 lg:pt-12 border-t border-white/10">
                <h2 class="mb-12 text-lg lg:text-[36px] font-black text-black">Описание</h2>
            ...
            @if($also)
                <section class="mt-16 xl:mt-24">
                    <h2 class="mb-12 text-lg lg:text-[36px] font-black text-black">Просмотренные товары</h2>
                    <!-- Products list -->
