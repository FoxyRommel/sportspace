<div>
    ...
    <div class="flex items-center justify-between gap-3 mb-2">
        <span class="text-body text-xxs font-medium">От, руб </span>
        <span class="text-body text-xxs font-medium">До, руб</span>
    </div>
    ...
    <div class="flex items-center gap-3">
        <input
            ...
            type="number"
            class="w-full h-12 px-4 rounded-lg border border-body/10 focus:border-orange focus:shadow-[0_0_0_3px_#fb5712] bg-white/5 text-white text-xs shadow-transparent outline-0 transition"
            placeholder="От"
        >
