...
@section('content')
    ...
    <section>
        <!-- Section heading -->
        <h2 class="text-lg lg:text-[42px] font-black text-black">Категории</h2>
    ...
    <section class="mt-16 lg:mt-24">
        <!-- Section heading -->
        <h2 class="text-lg lg:text-[42px] font-black text-black">Каталог товаров</h2>
            ...
            <div class="basis-auto xl:basis-3/4">
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                    <div class="flex items-center gap-4">
                        ...
                        <div class="text-black-200 text-xxs sm:text-xs">
                    ...
                    <div x-data="{sort: '{{ filter_url($category, ['sort' => request('sort')]) }}'}" class="flex flex-col sm:flex-row sm:items-center gap-3">
                        <span class="text-black-200 text-xxs sm:text-xs">Сортировать по</span>
                            <select
                                name="sort"
                                x-model="sort"
                                x-on:change="window.location = sort"
                                class="form-select w-full h-12 px-4 rounded-lg border border-black focus:border-pink focus:shadow-[0_0_0_3px_#EC4176] bg-white/5 text-white text-xxs sm:text-xs shadow-transparent outline-0 transition">
