...
@section('title', env('APP_NAME'))
 ...
 <div class="home">
		<div class="home_container">
			<div class="home_background" style="background-image:url(images/istockphoto-613555120-612x612.jpg)"></div>
...
@section('content')
    <main class="py-16 lg:py-20">
        <div class="container">
            <section>
                <!-- Section heading -->
                <h1 class="mb-8 text-lg lg:text-[36px] font-black text-black">Оформление заказа</h1>
                ...
                <form action="{{ route('order.handle') }}" method="POST" class="grid xl:grid-cols-3 items-start gap-6 2xl:gap-8 mt-12">
                    ...
                    <div class="p-6 2xl:p-8 rounded-[20px] bg-card">
                        <h3 class="mb-6 text-md 2xl:text-lg font-bold text-white">Контактная информация</h3>
                        <div class="space-y-3">
                            <x-forms.text-input
                    ...
                    <div class="space-y-6 2xl:space-y-8">
                        ...
                        <!-- Shipping-->
                        <div class="p-6 2xl:p-8 rounded-[20px] bg-card">
                            <h3 class="mb-6 text-md 2xl:text-lg font-bold text-white">Способ доставки</h3>
                            <div class="space-y-5">
                        ...
                        <!-- Payment-->
                        <div class="p-6 2xl:p-8 rounded-[20px] bg-card">
                            <h3 class="mb-6 text-md 2xl:text-lg font-bold text-white">Метод оплаты</h3>
                            <div class="space-y-5">
                    ...
                    <!-- Checkout -->
                    <div class="p-6 2xl:p-8 rounded-[20px] bg-card">
                        <h3 class="mb-6 text-md 2xl:text-lg font-bold text-white">Заказ</h3>
                        <table class="w-full border-spacing-y-3 text-body text-xxs text-left text-white" style="border-collapse: separate">
                        ...
                        <div class="text-xs font-semibold text-right text-white">Всего: {{ cart()->amount() }}</div>
                        ...
                        <div class="mt-8 space-y-8">
                            ...
                            <table class="w-full text-left">
                                <tbody>
                                    <tr>
                                        <th scope="row" class="text-md 2xl:text-lg font-black text-white">Итого:</th>
                                        <td class="text-md 2xl:text-lg font-black text-white">{{ cart()->amount() }}</td>
                                    </tr>
                                </tbody>
                            </table>
